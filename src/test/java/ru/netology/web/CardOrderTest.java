...
public class CardOrderTest {
    ...
    void shouldCardFormWithDash() {
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Дон-Сантос Дуглас"); // Двойная фамилия через тире
    ...
    void shouldCardFormWithSpace() {
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Дон Сантос Дуглас"); // Двойная фамилия через пробел
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+71234567899");
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.className("button")).click();
    ...
    void shouldCardFormJustName() {
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Дон"); // Только имя без фамилии
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+71234567899");
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.className("button")).click();
    ...
    void shouldCardFormInvalidName() {
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Jon Stefan"); // Имя набрано латиницей
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+71234567899");
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.className("button")).click();
    ...
    void shouldCardFormWithoutPhone() { // В заявке отсутствует номер телефона
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Джон Дуглас");
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.className("button")).click();
